...
export class wxFactory extends baseFactory {
    constructor() {
        super();
        this.loadScript();
    }
    ...
    login(params) {
        return new Promise((resolve, reject) => {
            ...
            api.getWXUser(params).then(res => {
                resolve(res.userId); //用户登入成功
            }, () => {
    ...
    initSDK(isComponent) {
        ...
        return new Promise((resolve, reject) => {
            api.getWXConfig(appSecret,isComponent).then((res) => {
                //微信js-skd 初始化
                window.wx.config({
    ...
    postTransformVoice(params) {
        Vue.prototype.$apiFactory.postMediaVoice({
            "appId": appId,
            "appSecret": appSecret,
            ...params
        });
